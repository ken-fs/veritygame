...
export default function WhichVerityPage() {
  ...
  const faq = generateFAQSchema([
    ...
    },
    {
      ...
      answer:
        'Build Base to Survive VERITY and Verity\'s Game are the busiest, both around 4,000+ concurrent players. The original Verity™ has cooled to roughly 50 concurrent players since its viral peak, while Verity Companion [AI] has the highest total visits at 30M+.',
    },
    {
